$(document).ready(function () {
    $('#fullpage').fullpage({
        sectionsColor: ['#232323', '#000', '#FFF', '#375CBA', '#8D4B4E', '#746348'],
  ...
  function Timeline(cvs) {
      ...
      self.dotColors = [
          ['#375CBA', 'rgba(55, 92, 186, 0.3)', 'rgba(55, 92, 186, 0.08)'],
          ['#000', 'rgba(0, 0, 0, 0.3)', 'rgba(0, 0, 0, 0.12)'],
      ];
      ...
      function init() {
          ...
          try {
              ...
              self.lines[0] = new Line(0, canvas.offsetHeight - 100, '#375CBA', self.options, mouse);
              self.lines[1] = new Line(0, canvas.offsetHeight - 100, '#000', self.options, mouse);
          } catch (e) {
              return false;
          }
